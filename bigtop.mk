...
IGNITE_HADOOP_BASE_VERSION=1.2.0
...
ZEPPELIN_RELNOTES_NAME=Zeppelin
ZEPPELIN_PKG_NAME=zeppelin
ZEPPELIN_BASE_VERSION=0.5.0-incubating
ZEPPELIN_PKG_VERSION=0.5.0
ZEPPELIN_RELEASE_VERSION=1
ZEPPELIN_TARBALL_DST=zeppelin-$(ZEPPELIN_BASE_VERSION).tar.gz
ZEPPELIN_TARBALL_SRC=zeppelin-$(ZEPPELIN_BASE_VERSION).tgz
ZEPPELIN_DOWNLOAD_PATH=/incubator/zeppelin/$(ZEPPELIN_BASE_VERSION)/
ZEPPELIN_SITE=$(APACHE_MIRROR)$(ZEPPELIN_DOWNLOAD_PATH)
ZEPPELIN_ARCHIVE=$(APACHE_ARCHIVE)$(ZEPPELIN_DOWNLOAD_PATH)
