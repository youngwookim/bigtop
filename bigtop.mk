...
# BIGTOP_DB
BIGTOP_DB_NAME=bigtop-db
BIGTOP_DB_RELNOTES_NAME=Bigtop Metastore
BIGTOP_DB_PKG_NAME=bigtop-db
BIGTOP_DB_BASE_VERSION=0.9.0
BIGTOP_DB_PKG_VERSION=0.9.0
BIGTOP_DB_RELEASE_VERSION=1
BIGTOP_DB_TARBALL_DST=bigtop-db-$(BIGTOP_DB_BASE_VERSION).tar.gz
$(eval $(call PACKAGE,bigtop-db,BIGTOP_DB))
