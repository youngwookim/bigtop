...
Source2: install_zeppelin.sh
Source3: init.d.tmpl
Source4: zeppelin.svc
Source5: bigtop.bom
Requires: bigtop-utils >= 0.7, hadoop-client, spark-core >= 1.3, hive, zookeeper
...
bash $RPM_SOURCE_DIR/init.d.tmpl $RPM_SOURCE_DIR/%{name}.svc rpm $RPM_BUILD_ROOT/%{initd_dir}/%{name}

%__rm -f $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/hadoop-*.jar
%__rm -f $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/hive-*.jar
%__rm -f $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/zookeeper-*.jar

%__ln_s /usr/lib/zookeeper/zookeeper.jar  $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/

%__ln_s /usr/lib/hadoop/client/hadoop-annotations.jar  $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/
%__ln_s /usr/lib/hadoop/client/hadoop-auth.jar  $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/
%__ln_s /usr/lib/hadoop/client/hadoop-common.jar  $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/

%__ln_s /usr/lib/hive/lib/hive-common.jar $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/
%__ln_s /usr/lib/hive/lib/hive-jdbc.jar $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/
%__ln_s /usr/lib/hive/lib/hive-metastore.jar $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/
%__ln_s /usr/lib/hive/lib/hive-serde.jar $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/
%__ln_s /usr/lib/hive/lib/hive-service.jar $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/
for jar in $(`ls /usr/lib/hive/lib/hive-shims*.jar`) ; do
%__ln_s ${jar} $RPM_BUILD_ROOT/%{lib_zeppelin}/interpreter/hive/
done
